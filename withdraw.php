...
?>
  <div class='cont'><br><br>
    <h2 style="font-family: garamond;color:black" >&emsp;WITHDRAW MONEY</h2>
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <button class='btn btn-outline-dark' name='submit'>WITHDRAW MONEY</button>
        </form>
      </div>
    </div>
  </div>
  ...
  $x=mysqli_num_rows($rs);
   ...
   if($x>0)
   {
    ...
    if($camt>=$amount){
      ...
      $t=date('h:i:s');
      $dt=$d."  ".$t;
      $q="insert into mytran(acno,amount,dt,ds)values('$account','$amount','$dt','withdraw')";
      mysqli_query($con,$q);
   ...
   echo "<h3> INVALID ACCOUNT OR PIN";
